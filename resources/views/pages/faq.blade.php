                    ...
                    <div class="cbp cbp-l-grid-faq js__grid-faq">
                        <div class="cbp-item buying">
                            <div class="cbp-caption">
                                <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                    ...
                                    <h2 class="s-faq-grid__title">Where can I find my Purchase Activation Key?</h2>
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Every item purchased has a unique code, called a application key.
                                        <br>
                                        A purchase key is used by authors to verify you have purchased a licence for the item. The purchase code may be required to access an author’s support site (if support is offered) or to enable automatic updates.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cbp-item community">
                            <div class="cbp-caption">
                                <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                    ...
                                    <h3 class="s-faq-grid__title">Forum Comments by Cavidel Staff &amp; Moderators</h3>
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Cavidel is extremely fortunate to have a huge community with highly engaged users. Part of our community’s time on Cavidel Market is spent within our forums, our common grounds for communication. In order to clarify the different roles and responsibilities of the various people and roles that post in our forums we hope you find the following information useful.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cbp-item buying">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Authors who are designers, developers and creatives from all over the globe are responsible for the work you see on Cavidel Market.
                        ...
                        {{-- <div class="cbp-item author">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        As an Cavidel Market author you need to select the most appropriate payment method in order to receive your earnings.
                                        <br>
                        ...
                        <div class="cbp-item author">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Over the years Cavidel Market has changed fees &amp; rates several times – always in favour of our authoring community! If you have been selling files for some time, these rates may apply to you. If you are a new author, you should review our Current Rates or read about our author program If you are interested in Selling Your Work.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="cbp-item account">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Sign in to your Cavidel Account via the button at the top right of the Cavidel Market sites.
                                        <br>
                    ...
                    <div class="cbp cbp-l-grid-faq js__grid-faq">
                        <div class="cbp-item account">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        It is important that your Cavidel Account has a secure, private password at all times.
                                        <br>
                                        Sign in to your Cavidel Account via the button at the top right of the Cavidel Market sites.
                                    </div>
                                </div>
                        ...
                        <div class="cbp-item author">
                            <div class="cbp-caption">
                                <div class="s-faq-grid__divider cbp-caption-defaultWrap">
                                    ...
                                    <h4 class="s-faq-grid__title">An Author’s Introduction to Cavidel Market</h4>
                                </div>
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Becoming an author on Cavidel Market carries certain legal implications. Everything you sell must be your own original content. If you use any assets that are owned by someone else, you must have a license that grants you permission to use and resell them.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cbp-item copyright">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Cavidel Market is not a legal body which is qualified to give you advice on these matters.  Any suggestions on this page are to be considered general and not specific to your situation. When sending legal documentation or taking any form of legal action, we recommend you consult with a legal professional. We can take no responsibility for the repercussions of following the suggestions in this document.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cbp-item community">
                            <div class="cbp-caption">
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="g-color--white-opacity">
                                        Cavidel takes great pride in it’s global and thriving community! They're part of what makes the Cavidel Market sites fun and friendly. The forum rules and guidelines focus on mutual respect.
                                        <br>

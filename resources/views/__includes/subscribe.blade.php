<!-- Subscribe -->
<div class="js__parallax-window" style="background: url(img/1920x1149/02.jpg) 50% 0 no-repeat fixed;">
    <div class="g-container--sm g-text-center--xs g-padding-y-60--xs g-padding-y-100--sm">
        <div class="g-margin-b-80--xs">
            ...
            <h2 class="g-font-size-32--xs g-font-size-36--md g-color--white">Join Over 16+ Clients</h2>
        </div>
        <div class="row">

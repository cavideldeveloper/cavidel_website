      ...
      <div class="modal-body">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu dropdown-menu-right animated fadeInUpShort" role="menu">
            <li><a href="dashboard.html#" data-set-lang="en">English</a></li>
            <li><a href="dashboard.html#" data-set-lang="es">Spanish</a></li>
          </ul>
        </div>
        <!-- END Language list-->
      </div>
...
<!-- Add Software modal-->
<div class="modal fade" id="add-software" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form method="post" onsubmit="return addSoftware()">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>What name will you like to call this project?</label>
                <input type="text" id="project_name" class="form-control" placeholder="Enter project name.." name="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>What sector does the project belogns to?</label>
                <select class="form-control" id="project_sector">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="project_clients" placeholder="Enter client's name.." name="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Client Company?</label>
                <input type="text" class="form-control" id="project_company" placeholder="Enter company's name.." name="">
              </div>
            </div>
          </div>

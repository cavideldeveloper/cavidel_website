...
jQuery(document).ready(function(e) {
    var t=6.437431, i=3.434665, s=6, l=navigator.userAgent.toLowerCase().indexOf("trident")>-1, o=l?"img/widgets/gmap/cd-icon-location.png":"img/widgets/gmap/cd-icon-location.svg", n="#f7f8fa", r=-70, a=40, y=[ {
    ...
    , {
        ...
        center: new google.maps.LatLng(t, i), zoom: s, panControl: !1, zoomControl: !1, mapTypeControl: !1, streetViewControl: !1, mapTypeId: google.maps.MapTypeId.ROADMAP, scrollwheel: !1, styles: y
    }
    , g=new google.maps.Map(document.getElementById("js__google-container"), p), u='<div id="content"><div id="siteNotice"></div><h2 id="firstHeading" class="firstHeading">Victoria Island</h2><div id="bodyContent"><p>1004 Housing Estate, <br> America International School, Immidiate Area, Lagos, NY 11211, <br> Lagos State, NG</p></div></div>', m=new google.maps.InfoWindow( {
